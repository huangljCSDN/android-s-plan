...
public class Luban {
    ...
    public File thirdCompress(@NonNull File file) {
        String thumb = FilePathUtils.getIntance(ct).getDefaultPicturePath() + File.separator + file.getAbsolutePath().hashCode() + ".jpg";
    ...
    private File firstCompress(@NonNull File file) {
        ...
        String filePath = file.getAbsolutePath();
        String thumbFilePath = mCacheDir.getAbsolutePath() + File.separator + filePath.hashCode() + ".jpg";
