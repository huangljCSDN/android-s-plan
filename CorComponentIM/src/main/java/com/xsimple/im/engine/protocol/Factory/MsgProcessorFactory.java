...
public class MsgProcessorFactory extends ProcessorFactory<String, MsgEntity, IMMessage> {

    public MsgProcessorFactory(Context mCt, DbManager mDbManager) {
    ...
    protected void initProcessorMap(Map<String, Processor<MsgEntity, IMMessage>> processorMap) {
        ...
        MsgProcessor msgProcessor = new MsgProcessor(mCt, mDbManager);
