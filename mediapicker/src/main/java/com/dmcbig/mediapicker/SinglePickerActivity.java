...
import com.dmcbig.mediapicker.adapter.SingleMediaGridAdapter;
...
public class SinglePickerActivity extends Activity implements DataCallback, View.OnClickListener {

    Intent argsIntent;
    RecyclerView recyclerView;
    Button done, category_btn, preview;
    SingleMediaGridAdapter gridAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sigle_picker);
...
//        ArrayList<Media> select = argsIntent.getParcelableArrayListExtra(PickerConfig.DEFAULT_SELECTED_LIST);
        ...
        gridAdapter = new SingleMediaGridAdapter(medias, this, select, maxSelect, maxSize);
    ...
    void setView(ArrayList<Folder> list) {
        ...
        setButtonText();
        gridAdapter.setOnItemClickListener(new SingleMediaGridAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onItemClick(View view, Media data, ArrayList<Media> selectMedias) {
                Intent intent = new Intent(SinglePickerActivity.this, SinglePreviewActivity.class);
                ...
                SinglePickerActivity.this.startActivityForResult(intent, 200);
            }
        });
