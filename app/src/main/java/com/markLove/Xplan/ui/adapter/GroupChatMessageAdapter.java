...
public class GroupChatMessageAdapter extends RecyclerView.Adapter<ChatBaseViewHolder> {
    ...
    public GroupChatMessageAdapter(Context context, List<Message> datas) {
    ...
    public ChatBaseViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (ViewType.values()[viewType]) {
            case SEND_TXT:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_send_txt_item, viewGroup, false);
                holder = new ChatTxtViewHolder(view);
                break;
            case RECEIVED_TXT:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_received_txt_item, viewGroup, false);
                holder = new ChatTxtViewHolder(view);
                break;
            case SEND_IMG:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_send_img_item, viewGroup, false);
                holder = new ChatImgViewHolder(view);
                break;
            case RECEIVED_IMG:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_received_img_item, viewGroup, false);
                holder = new ChatImgViewHolder(view);
                break;
            case LOVE:
                ...
                break;
            case SEND_VOICE:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_send_voice_item, viewGroup, false);
                holder = new ChatVoiceViewHolder(view);
                break;
            case RECEIVED_VOICE:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_received_voice_item, viewGroup, false);
                holder = new ChatVoiceViewHolder(view);
                break;
            case SUPERLIKE:
                ...
                break;
            case SEND_GIFT:
                view = LayoutInflater.from(context).inflate(R.layout.group_chat_send_gift_item, viewGroup, false);
        ...
        public void setChatContent(Message msg) {
            ...
            if (body instanceof FileMessageBody) {
                ...
                if (new File(imgPath1).exists()) {
                    ...
                    int damageImg = R.drawable.bg_icon_default;
                    String url = imgPath3;
...
//            ImageLoaderUtils.display(context, new File(imgPath), imgMsg, width, height);
    ...
    static class ChatLoveViewHolder extends ChatBaseViewHolder {
        ...
        public ChatLoveViewHolder(View itemView, GroupChatMessageAdapter adapter) {
            super(itemView);
            llBecomeLoveContent = (LinearLayout) itemView.findViewById(R.id.chat_become_Content_ll);
            tvBecomeLoveMsg = (TextView) itemView.findViewById(R.id.tv_become_loves_msg);
            llBecomeLove = (LinearLayout) itemView.findViewById(R.id.become_love_ll);
    ...
    static class ChatVoiceViewHolder extends ChatBaseViewHolder {
        ...
        private void setVoiceResource(Message msg, String voicePath) {
            ...
            if (msg.getFromID() == PreferencesUtils.getInt(context, Constants.ME_USER_ID)) {
                ...
                voicePlayer.setImageResource(R.drawable.group_received_voice_5);
            }
        }
    }
    ...
    class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        private void playVoice(Message msg, String voicePath) {
            ...
            if (msg.getFromID() == PreferencesUtils.getInt(context, Constants.ME_USER_ID)) {
                ...
                voicePlayer.setImageResource(R.drawable.group_send_voice_5);
                final AnimationDrawable drawable = (AnimationDrawable) ContextCompat.getDrawable(context, R.drawable.group_received_voice_anim);
                if (!(boolean) voicePlayer.getTag()) {
                    ...
                    drawable.stop();
                    drawable.selectDrawable(1);
                    voicePlayer.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.group_send_voice_5));
                    voicePlayer.setTag(false);
                }
            }
        }
