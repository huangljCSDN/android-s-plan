...
public class CircleProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        radius = typeArray.getDimension(R.styleable.CircleProgressbar_radiu, 80);
        strokeWidth = typeArray.getDimension(R.styleable.CircleProgressbar_stroke_Width, 10);
...
//            canvas.drawText(txt, getWidth() / 2 - txtWidth / 2, getHeight() / 2 + txtHeight / 4, textPaint);
    ...
    public void setProgress(int progress) {
        ...
        LogUtils.i("huang","currentProgress="+currentProgress);
        postInvalidate();
    }
}
