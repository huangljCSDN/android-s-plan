 ...
 * 店铺聊天室
 */
public class ShopChatTestActivity extends BaseActivity<ShopChatPresenter> implements View.OnClickListener, ChatView, ShopChatContract.View,IMChatCallBack {
...
//                judeBlackList(message);
                sendVoice(((FileMessageBody)message.getBody()).getFilePath());
            }
        });
        ...
        rlChatMsgList.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
                outRect.left = 0;
                outRect.right = 0;
                outRect.bottom = DensityUtils.dip2px(ShopChatTestActivity.this, 10f);
                outRect.top = DensityUtils.dip2px(ShopChatTestActivity.this, 10f);
            }
        });
    ...
    private void startMerchantMemberActivity() {
        Intent intent = new Intent(ShopChatTestActivity.this, MerchantMemberActivity.class);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == Constants.REQUEST_CODE_PERMISSION_ONE) {
            ...
            if (grantResults.length >= 1) {
                ...
                if (size == 0) {
                    startActivityForResult(new Intent(ShopChatTestActivity.this, CameraActivity.class), Constants.REQUEST_CODE_CAMERA);
                } else {
...
//        routerCallback = callback;
    ...
    public static Intent getStartIntent(Context context, MemEntity memEntity) {
        Intent intent = new Intent(context, ShopChatTestActivity.class);
...
//        final MemEntity memEntity = (MemEntity) getIntent().getSerializableExtra(EXTRA_TARGET);
        ...
        mImChatControl = new IMChatLogic.Build() {
            ...
            public IMChatCallBack setIMChatCallBack() {
                return ShopChatTestActivity.this;
            }
