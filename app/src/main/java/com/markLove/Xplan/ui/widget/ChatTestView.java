 ...
 * 描述：
 */
public class ChatTestView extends FrameLayout implements View.OnClickListener{
    ...
    public ChatTestView(@NonNull Context context) {
        this(context,null);
    }

    public ChatTestView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ChatTestView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        }
     ...
     * 设置草稿
     */
    public void setDrafts(String context) {
        if (TextUtils.isEmpty(context))
            return;
//        isNeedToBeConverted = true;
//        isDraft = true;
        Editable editable = mEditTextView.getText();
        editable.append(AtUtil.spannableFilter(mContext, new SpannableString(context), mEditTextView.getTextSize()));
//        isDraft = false;
    }
}
