 ...
 * 描述：内容为空弹窗
 */
public class ContentEmptyDialog extends AlertDialog implements View.OnClickListener{

	public ContentEmptyDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_content_empty);
